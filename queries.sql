...
INSERT INTO
    task (name, date, cat_id, file, done, user_id)
VALUES
    ('Собеседование в IT компании', '2022-05-17', '3', null, '0', '1'),
    ('Выполнить тестовое задание', '2022-05-17', '2', null, '0', '1'),
    ('Сделать задание первого раздела', '2022-05-017', '2', null, '1', '1'),
    ('Встреча с другом', '2022-05-17', '1', null, '0', '1'),
    ('Купить корм для кота', '2021-05-09', '4', null, '0', '1'),
    ('Заказать пиццу', '2022-05-17', '4', null, '0', '1');
