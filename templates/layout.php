...
<head>
    <meta charset="UTF-8">
    <title><?php echo $page_title ?? false; ?></title>
                ...
                <div class="main-header__side-item user-menu">
                    <?php if (!empty($user)) : ?>
                        <div class="user-menu__data">
                            <p><?php echo isset($user_name) ?
                            htmlspecialchars($user_name) : '' ?></p>
                            <a href="logout.php">Выйти</a>
                        </div>
                    <?php else : ?>
                        <div class="main-header__side">
                            <a class="main-header__side-item button
                            button--transparent" href="auth.php">Войти</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="main-footer__social social">
            ...
            <a class="social__link social__link--facebook" href="#">
                ...
                xmlns="http://www.w3.org/2000/svg">
                    <circle stroke="#879296" fill="none"
                    cx="13.5" cy="13.5" r="12.667"/>
                    <path fill="#879296"
        ...
        <div class="main-footer__developed-by">
            ...
            <a href="https://htmlacademy.ru/intensive/php">
                <img src="img/htmlacademy.svg" alt="HTML Academy"
                width="118" height="40">
            </a>
        </div>
    </div>
