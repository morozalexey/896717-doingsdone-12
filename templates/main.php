    ...
    <section class="content__side">
        ...
        <nav class="main-navigation">
            <ul class="main-navigation__list">
                ...
                ">
                    <a class="main-navigation__list-item-link" href="/?cat_id=<?= $category['id'] ; ?>"><?= $category['name'] ; ?></a>
                    <span class="main-navigation__list-item-count">
                    <?= (isset($_GET['cat_id'])) ? task_сount($all_tasks, $category['id']) : task_сount($tasks, $category['id']) ;?></span>
                </li>
                <?php endforeach ; ?>
            </ul>
        </nav>
